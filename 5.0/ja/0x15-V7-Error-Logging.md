...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **1.7.1** | [7.1.7 へ移動] | | v5.0.be-1.7.1 |
| **1.7.2** | [7.3.5 へ移動] | | v5.0.be-1.7.2 |
...
| **7.1.2** | [削除, 7.1.1 へマージ] | | v5.0.be-7.1.2 |
| **7.1.3** | [7.2.3 へ移動] | | v5.0.be-7.1.3 |
| **7.1.4** | [修正] 各ログエントリにはイベントが発生した時のタイムラインの詳細な調査を可能にするために必要なメタデータが含まれている。 | 2 | v5.0.be-7.1.4 |
| **7.1.5** | [7.3.4 から移動] 時刻ソースが正しい時刻とタイムゾーンに同期している。インシデント後のフォレンジック解析を支援するためにシステムがグローバルである場合には、UTC でのみログを記録することを強く検討する。 | 2 | v5.0.be-7.1.5 |
...
| **7.3.2** | [削除] | | | v5.0.be-7.3.2 |
| **7.3.3** | [修正] ログは不正なアクセスから保護されており、改変できない。 | 2 | v5.0.be-7.3.3 |
| **7.3.4** | [7.1.5 へ移動] | | v5.0.be-7.3.4 |
| **7.3.5** | [1.7.2 から移動] 分析、検出、警告、エスカレーションのために、ログができればリモートシステムにセキュアに転送されている。 | 2 | v5.0.be-7.3.5 |
