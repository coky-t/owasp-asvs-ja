...
| **2.6.2** | [修正, 2.6.4 へ分割] 112 ビット未満のエントロピー (19 個のランダムな英数字または 34 個のランダムな数字) を持つルックアップシークレットは 32 ビットのランダムソルトを組み込んだ承認されたパスワードストレージハッシュアルゴリズムでハッシュ化されている。シークレットが 112 ビット以上のエントロピーを持つ場合、標準的なハッシュ関数を使用できる。 | | ✓ | ✓ | 330 | 5.1.2.2 |
