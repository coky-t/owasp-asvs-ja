...
| # | 説明 | L1 | L2 | L3 | CWE |
| :---: | :--- | :---: | :---: | :---: | :---: |
| **4.3.1** | [修正] 管理インタフェースはメインアプリケーションから分離され、信頼できるエンドポイントからの接続のみを受け入れている。例としては、要塞ホストやジャンプホストの使用、管理ワークテーションのみへのアクセス制限、他のユーザとは別のドメインでの管理機能の提供、イントラネット経由の管理アクセスのみを許可するなどがある。 | ✓ | ✓ | ✓ | 419 |
