...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **1.12.1** | [削除] | | v5.0.be-1.12.1 |
| **1.12.2** | [削除, 50.6.1 へマージ] | | v5.0.be-1.12.2 |
...
| **12.1.3** | 一人のユーザが非常に多くのファイルや極端に大きなファイルでストレージをいっぱいにすることができないように、ファイルサイズクォータとユーザあたりの最大ファイル数が適用されている。 | 3 | v5.0.be-12.1.3 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **12.2.1** | [12.1.5 へ移動] | | v5.0.be-12.2.1 |

## V12.3 ファイル実行

| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **12.3.1** | [12.4.3 へ移動] | | v5.0.be-12.3.1 |
| **12.3.2** | [削除, 12.4.3 へマージ] | | v5.0.be-12.3.2 |
| **12.3.3** | [削除, 12.4.3 へマージ] | | v5.0.be-12.3.3 |
| **12.3.4** | [12.5.3 へ移動] | | v5.0.be-12.3.4 |
| **12.3.5** | [削除, 5.3.8 でカバー] | | v5.0.be-12.3.5 |
| **12.3.6** | [削除, 1.10.2 でカバー] | | v5.0.be-12.3.6 |
...
| **12.4.2** | [12.5.5 へ移動] | | v5.0.be-12.4.2 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **12.5.1** | [14.3.5 へ移動] | | v5.0.be-12.5.1 |
| **12.5.2** | [50.6.1 へ移動] | | v5.0.be-12.5.2 |
| **12.5.3** | [修正, 12.3.4 から移動] アプリケーションが JSON, JSONP, URL パラメータに含まれるユーザが送信したファイル名を確認または無視し、レスポンスの Content-Disposition ヘッダフィールドでファイル名を指定している。 | 2 | v5.0.be-12.5.3 |
...
| **12.5.5** | [修正, 12.4.2 から移動] 信頼できないソースから取得したファイルが、既知の悪意のあるコンテンツの配信を防ぐためにウィルス対策スキャナによりスキャンされている。 | 2 | v5.0.be-12.5.5 |

## V12.6 SSRF 保護

| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **12.6.1** | [14.7.4 へ移動] | | v5.0.be-12.6.1 |
