...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **1.11.1** | [削除, スコープ外] | | v5.0.be-1.11.1 |
| **1.11.2** | [10.7.2 へ移動] | | v5.0.be-1.11.2 |
| **1.11.3** | [10.7.1 へ移動] | | v5.0.be-1.11.3 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **11.1.1** | アプリケーションは同じユーザのビジネスロジックフローをシーケンシャルなステップ順序でのみ処理し、ステップをスキップしない。 | 1 | v5.0.be-11.1.1 |
| **11.1.2** | [11.2.1 へ移動] | | v5.0.be-11.1.2 |
| **11.1.3** | [修正] ビジネスロジックの制限はアプリケーションのドキュメントに従って実装され、ビジネスロジックの欠陥が悪用されることを避けている。 | 2 | v5.0.be-11.1.3 |
| **11.1.4** | [11.2.2 へ移動] | | v5.0.be-11.1.4 |
| **11.1.5** | [削除, 11.3.1 へマージ] | | v5.0.be-11.1.5 |
| **11.1.6** | [10.7.3 へ移動] | | v5.0.be-11.1.6 |
| **11.1.7** | [7.2.4 へ移動] | | v5.0.be-11.1.7 |
| **11.1.8** | [削除, スコープ外] | | v5.0.be-11.1.8 |
