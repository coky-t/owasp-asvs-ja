...
| **1.6.2** | [削除, 14.8.1 へマージ] | | v5.0.be-1.6.2 |
| **1.6.3** | [削除, 6.2.4 へマージ] | | v5.0.be-1.6.3 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **6.1.1** | [削除, 1.8.1 へマージ] | | v5.0.be-6.1.1 |
| **6.1.2** | [削除, 1.8.1 へマージ] | | v5.0.be-6.1.2 |
| **6.1.3** | [削除, 1.8.1 でカバー] | | v5.0.be-6.1.3 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **6.2.1** | [修正] すべての暗号化モジュールがセキュアに失敗し、パディングオラクル攻撃などの脆弱性を有効にしない方法でエラーが処理される。 | 3 | v5.0.be-6.2.1 |
| **6.2.2** | [修正, 6.5.1, 6.5.2, 6.5.4, 6.6.1, 6.7.2 へ分割] 暗号操作には業界で検証済みの実装 (ライブラリやハードウェアアクセラレーション実装を含む) が使用される。 | 2 | v5.0.be-6.2.2 |
| **6.2.3** | [削除, 6.5.1, 6.5.2, 6.6.1 でカバー] | | v5.0.be-6.2.3 |
...
| **6.2.5** | [6.5.1, 6.5.2, 6.6.1 へ分割] | | v5.0.be-6.2.5 |
| **6.2.6** | [6.5.3 へ移動] | | v5.0.be-6.2.6 |
| **6.2.7** | [6.5.4 へ移動] | | v5.0.be-6.2.7 |
| **6.2.8** | 情報漏洩を防ぐために、すべての暗号化操作が一定時間であり、比較、計算、リターンの際に「短絡」操作がない。 | 3 | v5.0.be-6.2.8 |
...
| **6.3.2** | [削除, 6.3.1 でカバー] | | v5.0.be-6.3.2 |
...
| # | 説明 | レベル | #v5.0.be |
| :---: | :--- | :---: | :---: |
| **6.4.1** | [14.8.1 へ移動] | | v5.0.be-6.4.1 |
| **6.4.2** | [14.8.2 へ移動] | | v5.0.be-6.4.2 |
