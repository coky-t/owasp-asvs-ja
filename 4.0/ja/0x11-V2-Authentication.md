...
| **2.2.2** | [修正] 弱い認証子 (VoIP や電子メールなど) が認証方式として使用されていない。PSTN を使用する制限された認証子 (電話または SMS を使用して電話機に送信される OTP など) がより強い代替方式で提供されるか、二次検証とトランザクション承認に使用されている。制限された認証子はリスクに関する情報をユーザに提供すべきである。 | ✓ | ✓ | ✓ | 304 | 5.2.10 |
